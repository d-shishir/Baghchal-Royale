  ...
  <MainTab.Navigator
    screenOptions={({ route }) => ({
      ...
      tabBarIcon: ({ focused, color, size }) => {
        ...
        else if (route.name === 'Leaderboard') iconName = focused ? 'stats-chart' : 'stats-chart-outline';
...
const MainStackNavigator = () => (
  <MainStack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <MainStack.Screen name="SinglePlayerSetup" component={SinglePlayerSetupScreen} options={{ title: 'New AI Game' }} />
    <MainStack.Screen name="MultiplayerSetup" component={MultiplayerSetupScreen} />
    <MainStack.Screen name="Game" component={GameScreen} />
    <MainStack.Screen name="TournamentDetails" component={TournamentDetailsScreen} options={{ title: 'Tournament Details' }} />
    <MainStack.Screen name="Feedback" component={FeedbackScreen} options={{ title: 'Submit Feedback' }} />
  </MainStack.Navigator>
);
